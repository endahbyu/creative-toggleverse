  ...
  return (
    <section id="about" className="py-20 md:py-32 px-6 bg-secondary/20">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="section-title text-gradient-yellow">About Me</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            <div className="card-3d p-6">
              <h3 className="text-2xl font-bold mb-6 flex items-center text-gradient-yellow">
                <Sparkles className="w-6 h-6 mr-2" /> My Expertise
              </h3>
          ...
          >
            <div className="card-3d p-6">
              <h3 className="text-2xl font-bold mb-6 text-gradient-yellow">Skills</h3>
        ...
        <h3 className="text-2xl font-bold mb-8 text-center text-gradient-yellow">Services I Offer</h3>
            ...
            >
              <div className="flex justify-center mb-4">
                <div className="p-3 rounded-full bg-primary/10 mb-4">
                  <service.icon className="w-10 h-10 text-gradient-yellow" />
                </div>
              </div>
